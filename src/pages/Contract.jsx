...
export default function Contract() {
  ...
  const clauses = [
    ...
    ['Scope & work', 'Phase 1 delivers the referee webapp, the Tournament Command Centre, the referee appointing system, the AI communication assistant (the LLM chatbot and smart inbox), and the integration, testing and launch, all built on the phased setup described in the architecture and rollout plan in the commercial offer. Phase 2 is not part of this agreement and is quoted separately. Work not listed in the offer is additional work under the additional work clause.'],
    ...
    ['Changes & additional work', `Changes to the scope are agreed in writing, where email is sufficient. Additional work outside the agreed scope is charged at ${addRate} per hour excluding VAT and is separate from and not included in the monthly maintenance. Routine plugin and core updates are covered by the monthly maintenance. Only breaking changes, meaning changes required because third party platforms change in a way that breaks the platform, such as WordPress, WooCommerce or their APIs, are additional work.`],
